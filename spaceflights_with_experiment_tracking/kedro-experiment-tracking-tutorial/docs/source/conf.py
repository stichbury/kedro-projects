...
# kedro_experiment_tracking_tutorial documentation build
...
from kedro_experiment_tracking_tutorial import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_experiment_tracking_tutorial"
author = "Kedro"
...
htmlhelp_basename = "kedro_experiment_tracking_tutorialdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_experiment_tracking_tutorial.tex",
        "kedro_experiment_tracking_tutorial Documentation",
        "Kedro",
        "manual",
    )
]
...
man_pages = [
    (
        master_doc,
        "kedro_experiment_tracking_tutorial",
        "kedro_experiment_tracking_tutorial Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_experiment_tracking_tutorial",
        "Project kedro_experiment_tracking_tutorial codebase.",
        "Data-Science",
    )
]
